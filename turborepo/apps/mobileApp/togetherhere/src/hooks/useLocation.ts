...
import havesrine from "haversine-distance";
...
export default function useLocation () {
    ...
    function withinDistance (target : Coordinate, radiusMeters = 15) {
        if (!userLocation || !userLocation.coords.accuracy) return;
        return havesrine(target, userLocation.coords) <= radiusMeters + userLocation.coords.accuracy;
    }
